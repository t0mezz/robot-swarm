...
int main() {
    ...
    while (true) {
        ...
        {
            DemoHud hud;
            hud.title(DemoHud::fmt("loop_fps:%.0f  Robots:%d  HUB:%s  t:%.1fs",
        ...
        // ── Stacked-rows HUD (wingman style) ───────────────────────────────────
        {
            ...
            hud.row("Leader", "Robot 2  (WASD)", DemoHud::COL_WARN);
            hud.row("Spacing", "180 mm   Robots: 4");
            hud.row("loop_fps", DemoHud::fmt("%.1f", loopFps.fps()), DemoHud::COL_OK);
        ...
        {
            DemoHud hud;
            hud.title(DemoHud::fmt("loop_fps:%.0f  Robots:%d/4  HUB:%s",

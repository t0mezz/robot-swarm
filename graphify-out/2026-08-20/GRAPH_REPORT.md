# Graph Report - robot-swarm  (2026-08-20)
...
Cohesion: 0.07
Nodes (36): array, Buffer, unordered_map, N, PerRobot, appendf(), bipolarMeter(), brailleGraph() (+28 more)
...
### Community 24 - "drawTelHud"
Cohesion: 0.28
Nodes (10): string, Mode, main(), Mat, drawTelHud(), Mat, Scalar, drawPanel() (+2 more)

### Community 25 - "screen_manager.py"
Cohesion: 0.14
...
### Community 31 - "string"
Cohesion: 0.26
Nodes (7): condition_variable, defaultConfigPath, fromFile, mutex, string, scBatteryVolts(), main()

### Community 32 - "main"
Cohesion: 0.30
Nodes (9): bestX_, captureInteractive(), Mat, string, vector, loadFrameCache(), main(), parseArgs() (+1 more)

### Community 33 - "robot_uart.py"
Cohesion: 0.18
...
### Community 35 - "uart_controller.py"
Cohesion: 0.18
...
### Community 45 - "generate_marker_stl.py"
Cohesion: 0.31
